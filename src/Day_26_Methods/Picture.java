...
public class Picture {
    // Method Overloading.
    // When we have same method name and different parameters.
    ...
    */
    ...
    public static void draw (String color, int size) {
        System.out.println("Trying to draw with color " + color + " and size of " + size);
    }
    /*
        Type promotion:  If the method exist with the matching data type, it called that one.
    ...
    public static void test (double a) {
        System.out.println("Testing with double: " + a);
        /*
