...
public class ArrayIntro2 {
    public static void main(String[] args) {
        ...
        System.out.println(arr.length);  // 4 -----> LINE 1
        System.out.println(Arrays.toString(arr)); // LINE 2

        // How can I assign 30.99 to index 0
        arr [0] = 30.99;
        System.out.println(Arrays.toString(arr)); // LINE 3
        ...
        System.out.println(Arrays.toString(arr)); // LINE 5

        arr = new double[4]; //This creates a new array with 4 elements
        // And arr references to the new object
        System.out.println(Arrays.toString(arr)); // LINE 6
        System.out.println(arr[1]);               // LINE 7


        String [] strArr = new String[5];
        System.out.println(Arrays.toString(strArr)); // LINE 8
        ...
        System.out.println(arr2.length);  //  4 --->    LINE 9
